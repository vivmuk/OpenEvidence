...
var whatsNewData = [
  {
    ...
    updated: "Weekly research sweep (Tue Sep 22, 3:19 PM ET) — Venice Augment Search (16 queries) + arXiv API (50 results) + PubMed eutils (30 broad + 30 narrow). MAJOR FINDINGS: 2 new partnerships already tracked from daily runs (Penn Medicine Sep 15, MSK/OncoKB Sep 16). 5 new timeline entries added (Nadler TIME100 AI Aug 26, Talby regulatory duties, Waymark safety analysis, iatrox clinical AI landscape, Doximity physician study). OpenEvidence Model Family (Osler/Sackett/Snow/Darwin) added to products.js. 4 new sources added. 2 new competitor entries (Doximity study, Abridge NVIDIA/Lilly/Fortune). All 13 relevant arXiv papers already tracked from daily runs. 70 PMIDs already in research.json. No new PubMed papers this week — daily runs captured them. New benchmark-adjacent items: Talby regulatory duties analysis, Waymark safety stagnation analysis. Nadler TIME100 AI 2026 honor added to emergingTrends.",
    items: [
      {
